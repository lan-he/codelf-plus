  ...
  <div class="about">
    ...
    <main>
      ...
      <div class="esay">
        ...
        <p class="title">
          We’re a group of people with two goals in mind: For these goals, we
          welcome everyone to build with us, and together, we can retake our
          future. As one, We are Une.
        </p>
      </div>
      <div class="timeline">
  ...
  data() {
    return {
      ...
      activities: [
        ...
        {
          content:
            "Game platform and wallet launches using fiat currency for market testing",
          timestamp: "April 2021",
        },
        {
          content:
            "Game platform and wallet launches using fiat currencyfor market testing",
